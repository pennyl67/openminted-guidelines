#### typesystem inside inputContentResourceInfo or outputResourceInfo
...
when the s/w component takes as input \(or provides as output\) a resource that uses a specific typesystem
