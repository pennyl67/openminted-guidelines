...
A name or an identifier (e.g. url reference) to the source resource related to the target resource (relatedResource2) through a relation described in relationType 
##### Recommended usage
