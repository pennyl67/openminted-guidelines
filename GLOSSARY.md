...
## data model
A data model is an abstract model that organizes elements of data and standardizes how they relate to one another and to properties of the real world entities. [wikipedia: [https://en.wikipedia.org/wiki/Data_model](https://en.wikipedia.org/wiki/Data_model)]
...
The resource describes a language or some aspect(s) of a language via a systematic documentation of linguistic structures. [Open Language Archives Community, [http://www.language-archives.org/REC/type.html#language_description](http://www.language-archives.org/REC/type.html#language_description)] Examples include sketch grammar, computational grammar, etc.
...
## resource
Something that you can use to help you to achieve something, especially in your work or study. [MacMillan dictionary, [http://www.macmillandictionary.com/dictionary/british/resource_1](http://www.macmillandictionary.com/dictionary/british/resource_1)]
